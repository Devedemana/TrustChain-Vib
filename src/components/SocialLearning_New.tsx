...
//                           boxShadow: '0 16px 40px rgba(78, 205, 196, 0.2)'
//                         }
//                       }}>
//                         <CardContent sx={{ p: 3 }}>
//                           <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
...
//                                   <Typography variant="caption">{peer.location}</Typography>
//                                 </Stack>
//                                 <Stack direction="row" alignItems="center" spacing={1}>
//                                   <Schedule sx={{ fontSize: 16, color: 'text.secondary' }} />
//                                   <Typography variant="caption">{peer.studyTime}</Typography>
//                                 </Stack>
//                                 <Stack direction="row" alignItems="center" spacing={1}>
//                                   <EmojiEvents sx={{ fontSize: 16, color: 'text.secondary' }} />
//                                   <Typography variant="caption">{peer.credentials} credentials</Typography>
//                                 </Stack>
//                               </Stack>
//                             </Box>
...
//                       <Card sx={{
//                         borderRadius: 4,
//                         border: group.joined ? '2px solid #4CAF50' : '2px solid transparent',
//                         background: group.joined 
...
//                           boxShadow: group.joined ? '0 12px 30px rgba(76, 175, 80, 0.2)' : '0 12px 30px rgba(0,0,0,0.1)'
//                         }
//                       }}>
//                         <CardContent sx={{ p: 3 }}>
//                           <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
