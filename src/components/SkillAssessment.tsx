                  ...
                  {availableAssessments.map((assessment, index) => (
                    <Grid item xs={12} sm={6} lg={4} key={assessment.id}>
                      <Slide direction="up" in={animateIn} timeout={1000 + index * 200}>
                        <Card sx={{
                          borderRadius: 4,
                          border: assessment.completed ? '2px solid #4CAF50' : '2px solid rgba(255, 255, 255, 0.1)',
                          ...
                          <CardContent sx={{ p: 3 }}>
                            ...
                            <Typography variant="body2" sx={{ mb: 2, color: 'rgba(255, 255, 255, 0.9)', fontWeight: 500 }}>
              ...
              <Stack spacing={3}>
                ...
                <Slide direction="left" in={animateIn} timeout={1400}>
                  <Paper sx={{
                    ...
                    <Typography variant="body2" sx={{ mt: 2, color: 'white', fontWeight: 500 }}>
